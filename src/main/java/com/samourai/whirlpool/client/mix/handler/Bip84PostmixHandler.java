...
public class Bip84PostmixHandler extends AbstractPostmixHandler {
  ...
  public Bip84PostmixHandler(
          NetworkParameters params, BipWalletAndAddressType postmixWallet, boolean mobile) {
  ...
  protected MixDestination computeNextDestination() throws Exception {
    // index
    int index =
        ClientUtils.computeNextReceiveAddressIndex(postmixWallet.getIndexHandler(), this.mobile);
