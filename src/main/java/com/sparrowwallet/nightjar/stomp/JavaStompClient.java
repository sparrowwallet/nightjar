...
public class JavaStompClient implements IStompClient {
    ...
    @Override
    public void connect(String url, Map<String, String> stompHeaders, MessageErrorListener<Void, Throwable> onConnectOnDisconnectListener) {
    ...
    private StompSessionHandlerAdapter computeStompSessionHandler(final MessageErrorListener<Void, Throwable> onConnectOnDisconnectListener) {
        return new StompSessionHandlerAdapter() {
            @Override
            public void afterConnected(StompSession session, StompHeaders connectedHeaders) {
                super.afterConnected(session, connectedHeaders);
                if(log.isDebugEnabled()) {
                    log.debug("connected, connectedHeaders=" + connectedHeaders + ", stompSession=" + stompSession);
                }
            ...
            public void handleException(StompSession session, StompCommand command, StompHeaders headers, byte[] payload, Throwable exception) {
                ...
                log.error(" ! transportException: " + exception.getClass().getName() + ": " + exception.getMessage());
            }

            @Override
            public void handleTransportError(StompSession session, Throwable exception) {
                super.handleTransportError(session, exception);
                log.error(" ! transportError: " + exception.getClass().getName() + ": " + exception.getMessage());
                disconnect();
